...
<div class="row">
    <div class="c-banner">
        <div class="center">
            <img class="prod_logo"
                 src="<?php echo get_stylesheet_directory_uri(); ?>/dist/images/pro-d-logo-final.svg"
                 alt="pro-d logo">
            <img class="prod_logo_text"
                 src="<?php echo get_stylesheet_directory_uri(); ?>/dist/images/pro-d-logo-final-text.svg"
                 alt="pro-d logo text">
        </div>
    </div>
</div>
...
<div class="c-map row">
    ...
    <div class="ten columns">
		...
		?>
        <h2 class="text-center"><a class="text-gray" href="events"><?php prod_display_count_events(); ?> Training Events
